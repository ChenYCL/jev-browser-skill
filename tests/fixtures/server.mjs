...
export function createSite() {
  ...
  const server = http.createServer(async (req, res) => {
    ...
    if (p === "/combobox") return send(layout("Combobox", `<h1>Search the site</h1><form action="/search" method="get"><p><input id="q-ddg" name="q" type="search" role="combobox" aria-expanded="false" aria-autocomplete="list" aria-controls="suggestions" aria-label="Search with DuckDuckGo" placeholder="Search the web without being tracked"><ul id="suggestions" role="listbox"><li role="option">widgets</li><li role="option">gadgets</li></ul><button type="submit">Search</button></p></form><h2>ARIA 1.2 wrapper</h2><div role="combobox"><input id="q-wiki" name="w" type="search" aria-label="Search Wikipedia" placeholder="Search Wikipedia"></div><h2>Combobox with nothing to type into</h2><div role="combobox" id="recent-searches" aria-label="Recent searches">Recent searches</div><h2>Plain input</h2><p><input id="plain" name="plain" type="text" aria-label="Plain field" placeholder="Plain field"></p>`, { user }));
